       ...
       <div class="left-content">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <form id="formTipos" action="" method="">
                        <center><span id="resTipoGuardado"></span></center>
                        <?php  
                            if ($_GET['status'] == 1) {
                ...
                <center><button type="button" id="GuardarTipo" class="btn btn-primary hvr-grow">Guardar &nbsp;<span class="fa fa-save"></span></button></center>
            </form>
        </div>
        <br>
        <br>
