        ...
        <div class="sidebar-menu">
    		    ...
    		    <div class="menu">
    		      <ul id="menu" >
                    ...
                    <hr>
                    <li id="" class="text-center" ><a title="Universidad Luterana Salvadoreña, Centro Universitario Regional de Cabañas" target="_blank" href="http://curc.uls.edu.sv"><i class="fa fa-pie-chrt"></i><span><b>&nbsp;&nbsp;ULS - 2019</b></span></a></li>
    		      </ul>
    		    </div>
    	 </div>
