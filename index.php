...
<body>  
    <div class="container">
        ...
        <center><img height="50%" width="50%" class="" src="data:image/jpg;base64,<?php echo base64_encode($resultado['logoinstitucion']); ?>" alt="" ></center>
        </div>
                <br>
                <form autocomplete="off" method="post" action="programacion/validation.php">
                    ...
                    <center><button class="btn btn-primary hvr-grow">&nbsp;<span class="fas fa-sign-in-alt"></span> Entrar</button></center>
                    <br>
                </form>
                <?php  
