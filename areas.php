       ...
       <div class="left-content">
        ...
        <div class="col-md-8 col-md-offset-2">
            ...
            <form id="formAreas" action="" method="post">
                        <center><span id="resAreaGuardada"></span></center>
                        <?php  
                            if ($_GET['status'] == 1) {
                ...
                <center><button type="button" id="GuardarArea" class="btn btn-primary hvr-grow">Guardar &nbsp;<span class="fa fa-save"></span></button></center>
            </form>
        </div>
