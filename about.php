...
<body> 
     ...
     <div class="left-content">
        ...
        <div class="inner-block">
             ...
             <div class="col-md-6 market-update-gd">
                <div class="market-update-block clr-block-1" style="height: 300px !important;">
                   <div class="col-md-8 market-update-left">
                      <h4 class="text-center"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Carlos Martínez</h4>
					  <h5 class="text-center info">Estudiante 5° Licenciatura en Ciencias de la Computación</h5>
                      <br><br>
                      <div class="info">
          ...
          <div class="col-md-6 market-update-gd">
            <div class="market-update-block clr-block-1" style="height: 300px !important;">
               	<div class="col-md-8 market-update-left">
                   	<h4 class="text-center"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Noemí Acosta</h4>
					<h5 class="text-center info">Estudiante 5° Licenciatura en Ciencias de la Computación</h5>
                    <br><br>
                    <div class="info">
                    	<center>CONTACTO:</center>
      ...
      <div class="col-md-6 market-update-gd" style="margin-top: 40px;">
        <div class="market-update-block clr-block-1" style="height: 300px !important;">
           <div class="col-md-8 market-update-left">
             	<h4 class="text-center"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Jonás Morales</h4>
				<h5 class="text-center info">Estudiante 5° Licenciatura en Ciencias de la Computación</h5>
                <br><br>
                <div class="info">
                    <center>CONTACTO:</center>
                    <b><i class="fa fa-envelope-o" aria-hidden="true"></i>&nbsp;E-mail:</b> jonasajosuemoralese@gmail.com
                </div>
          </div>
          <div class="col-md-4 market-update-right">
  ...
  <div class="col-md-6 market-update-gd" style="margin-top: 40px;">
        <div class="market-update-block clr-block-1" style="height: 300px !important;">
           <div class="col-md-8 market-update-left">
             	<h4 class="text-center"><i class="fa fa-user" aria-hidden="true"></i>&nbsp;Adelaida Rivas</h4>
				<h5 class="text-center info">Estudiante 5° Licenciatura en Ciencias de la Computación</h5>
                <br><br>
                <div class="info">
                    <center>CONTACTO:</center>
...
<div class="sidebar-menu">
    		    ...
    		    <div class="menu">
    		      <ul id="menu" >
    		        ...
    		        <li id="menu-home" title="Universidad Luterana Salvadoreña"><a target="_blank" href="http://curc.uls.edu.sv"><i class="fa fa-university"></i><span>&nbsp;&nbsp;ULS</span></a></li>
    		        <li id="menu-home" title="Creative Commons 3.0"><a target="_blank" href="https://creativecommons.org/licenses/by/3.0/"><i class="fa fa-cc"></i><span>&nbsp;&nbsp;Licencia</span></a></li>
                <hr>
    		      </ul>
    		    </div>
    	 </div>
